...
export var wallSound = new soundFile("tap-8bit-resonant.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("tap-8bit.mp3");
...
export var adventureMusic = new soundFile("sawsquarenoise-TitleScreen.mp3");
soundArray.push(adventureMusic);
adventureMusic.player.loop = true;
adventureMusic.player.volume.value = -16;

export var villageMusic = new soundFile("sawsquarenoise-Stage3.mp3");
